...
void AClimbingSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Climbing
		EnhancedInputComponent->BindAction(ClimbAction, ETriggerEvent::Started, this, &AClimbingSystemCharacter::Startclimbing);
	}
	else
	{
	...
	Debug::Print(TEXT("Debug working..."),FColor::Green);
}
...
{
	Debug::Print(TEXT("Climb action started."), FColor::Blue);
}
